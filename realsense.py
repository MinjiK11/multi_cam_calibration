...
class RealSense:
    ...
    def __init__(self, serial_number, rgb_resolution, depth_resolution):
        ...
        self.serial_id = RealSense.serial_counter
        RealSense.serial_counter += 1
    ...
    def shoot(self):
        spatial  = rs.spatial_filter()         # smooths but preserves edges
        temporal = rs.temporal_filter()        # stabilizes over time
        ...
        depth_frame = spatial.process(depth_frame)        # KEY filter for wavy surfaces
